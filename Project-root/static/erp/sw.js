...
// v56: the Process WIP Pipeline is small multiples -- one doughnut per
// Process Type, its own processes as slices -- rather than stacked columns,
// and its slices carry the stage drill-down the columns used to. dashboard.js
