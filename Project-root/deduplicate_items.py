...
def deduplicate():
    ...
    with get_conn() as (conn, cur):
        ...
        for dup in duplicates:
            ...
            print(
                f"Processing duplicates for: {name}, {model_id}, {variation_id}, {description}"
            )
            ...
            for item_id in ids_to_delete:
                ...
                try:
                    ...
                    print(
                        f"    Could not re-associate variants for item_id {item_id}: {e}"
                    )
                ...
                print(
                    f"    Deleted duplicate item_master record for item_id {item_id}."
                )
