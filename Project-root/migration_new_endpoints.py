...
migrations = [
    ...
    (
        ...
        "Index on process_subprocess_id",
    ),
        ...
        with get_conn() as (conn, cur):
            ...
            for migration_sql, description in migrations:
                try:
                    ...
                    if "already exists" in str(step_e) or "duplicate key" in str(
                        step_e
                    ):
