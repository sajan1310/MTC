...
class VariantUsage:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.cost_per_unit: Optional[float] = float(data['cost_per_unit']) if data.get('cost_per_unit') else None
        self.total_cost: Optional[float] = float(data['total_cost']) if data.get('total_cost') else None
...
class ProcessTiming:
    ...
    def __init__(self, data: Dict[str, Any]):
        self.id: int = data['id']
        self.process_subprocess_id: int = data['process_subprocess_id']
        self.estimated_duration: Optional[float] = float(data['estimated_duration']) if data.get('estimated_duration') else None
        self.actual_duration: Optional[float] = float(data['actual_duration']) if data.get('actual_duration') else None
...
class Profitability:
    ...
    def __init__(self, data: Dict[str, Any]):
        self.id: int = data['id']
        self.process_id: int = data['process_id']
        self.total_worst_case_cost: Optional[float] = float(data['total_worst_case_cost']) if data.get('total_worst_case_cost') else None
        self.estimated_sales_price: Optional[float] = float(data['estimated_sales_price']) if data.get('estimated_sales_price') else None
        self.profit_margin: Optional[float] = float(data['profit_margin']) if data.get('profit_margin') else None
        self.profit_amount: Optional[float] = float(data['profit_amount']) if data.get('profit_amount') else None
...
class ProcessWorstCaseCosting:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.selected_alternative_variant_id: Optional[int] = data.get('selected_alternative_variant_id')
        self.cost_calculation_method: str = data.get('cost_calculation_method', 'worst_case')
        self.created_at: datetime = data.get('created_at', datetime.now())
        self.updated_at: datetime = data.get('updated_at', datetime.now())
