...
class ProductionLot:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.worst_case_estimated_cost: Optional[float] = float(data['worst_case_estimated_cost']) if data.get('worst_case_estimated_cost') else None
        self.actual_cost: Optional[float] = float(data['actual_cost']) if data.get('actual_cost') else None
    ...
    def calculate_variance(self) -> Optional[Dict[str, float]]:
        ...
        variance_pct = (variance / self.worst_case_estimated_cost * 100) if self.worst_case_estimated_cost > 0 else 0
...
class ProductionLotSelection:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.selected_cost: Optional[float] = float(data['selected_cost']) if data.get('selected_cost') else None
        self.selected_quantity: Optional[float] = float(data['selected_quantity']) if data.get('selected_quantity') else None
        self.created_at: datetime = data.get('created_at', datetime.now())
...
class ProductionLotActualCosting:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.worst_case_estimated: Optional[float] = float(data['worst_case_estimated']) if data.get('worst_case_estimated') else None
        self.actual_cost_paid: Optional[float] = float(data['actual_cost_paid']) if data.get('actual_cost_paid') else None
        self.variance: Optional[float] = float(data['variance']) if data.get('variance') else None
        self.variance_percentage: Optional[float] = float(data['variance_percentage']) if data.get('variance_percentage') else None
    ...
    def calculate_variance(self) -> None:
        ...
        if self.worst_case_estimated is not None and self.actual_cost_paid is not None:
            ...
            if self.worst_case_estimated > 0:
                self.variance_percentage = (self.variance / self.worst_case_estimated) * 100
            else:
