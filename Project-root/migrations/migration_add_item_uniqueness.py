...
def upgrade():
    ...
    with get_conn() as (conn, cur):
        ...
        cur.execute("ALTER TABLE item_master DROP CONSTRAINT IF EXISTS unique_item_master_name_model_variation_desc;")
        cur.execute("DROP INDEX IF EXISTS unique_item_master_name_model_variation_desc;")
