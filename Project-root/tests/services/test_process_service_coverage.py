        ...
        with patch('app.services.process_service.database.get_conn') as mock_conn:
            ...
            with patch.object(ProcessService, 'get_process') as mock_get:
                ...
                mock_cursor.fetchall.side_effect = [
                    # variants
                    [{'variant_id': 1, 'variant_name': 'Variant 1', 'opening_stock': 100}],
                    # cost_items
...
class TestProcessServiceEdgeCases:
    ...
    def test_concurrent_process_creation(self):
        ...
        with patch('app.services.process_service.database.get_conn') as mock_conn:
            ...
            mock_cursor.fetchone.side_effect = [
                {'id': 1, 'name': 'Process 1', 'status': 'Active', 'process_class': 'assembly', 'created_by': 1, 'created_at': '2025-01-01'},
                {'id': 2, 'name': 'Process 2', 'status': 'Active', 'process_class': 'assembly', 'created_by': 1, 'created_at': '2025-01-01'},
            ]
...
class TestProcessServiceIntegration:
    ...
    def test_create_and_retrieve_process(self):
        ...
        with patch('app.services.process_service.database.get_conn') as mock_conn:
            ...
            # Mock creation
            mock_cursor.fetchone.side_effect = [
                {'id': 1, 'name': 'New Process', 'description': 'Test', 'process_class': 'assembly', 'created_by': 1, 'status': 'Active', 'created_at': '2025-01-01'},
                # Then retrieval
                {'id': 1, 'name': 'New Process', 'description': 'Test', 'process_class': 'assembly', 'created_by': 1, 'status': 'Active', 'created_at': '2025-01-01'},
            ]
