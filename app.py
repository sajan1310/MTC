...
PRIMARY DEVELOPMENT RUNNER for the Manufacturing Tracking & Costing System.
...
UNIFIED RUNNER: This is the single entry point for development. It replaces
both the legacy top-level app.py and Project-root/run.py (which are kept for
...
Other runners:
- Project-root/run.py: Kept for backwards compatibility (points to this)
...
# Import from Project-root package
...
def main() -> None:
    ...
    try:
        app = create_flask_app(config_env)
    except Exception as e:
