        ...
        with app.test_client() as client:
            ...
            underscore_routes = [
                ...
                (
                    ...
                    {"production_lot_id": 1, "variant_id": 1, "required_quantity": 100},
                ),
                ...
                (
                    ...
                    "/api/procurement_recommendations",
                    {
                        ...
                        "required_delivery_date": "2025-12-01",
                    },
                ),
            ...
            with warnings.catch_warnings(record=True) as w:
                ...
                if len(w) > 0:
                    ...
                    print(
                        "Note: Warnings may not be captured due to test client request context."
                    )
