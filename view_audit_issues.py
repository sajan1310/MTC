...
print("=" * 70)
total_assets = len(data['static_assets']['css_files']) + len(data['static_assets']['js_files'])
minified = data['static_assets']['minified_count']
print(f"  • Only {minified}/{total_assets} assets are minified")
print(f"  • Consider minifying CSS/JS for production ({data['static_assets']['total_size']/1024:.1f} KB total)")
